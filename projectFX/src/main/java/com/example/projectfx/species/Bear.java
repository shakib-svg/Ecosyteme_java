...
public class Bear extends Omnivore {
    ...
    public void reproduce() {
        if (energy >= 50) { // Example: Bear needs at least 50 energy to reproduce
            System.out.println(name + " se reproduit et donne naissance à un ourson.");
            consumeEnergy(30); // Reproduction consumes energy
        } else {
            System.out.println(name + " n'a pas assez d'énergie pour se reproduire.");
        }
    }
