...
public class Canari extends Herbivore {
    ...
    public void eat(Object food) {
        if (food instanceof String && food.equals("seeds")) {
            System.out.println(name + " (Canari) is pecking at seeds.");
            energy += 10; // Eating seeds restores energy
        } else {
            System.out.println(name + " (Canari) cannot eat this type of food.");
        }
    }
